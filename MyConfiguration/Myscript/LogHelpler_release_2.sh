...
#
# History:
#   2013-12-20  gary    Second release
#
# Bugs:
...
DESDIR="${HOME}/.LogHelpler_singletaskmode"
...
if [ $# -lt 1 ]; then
    ...
    do
        ...
        if [ $CURRENTFILE -ge $startfrom ]; then
            $0 $var $2
        fi
    done
    if [ "$2" == "clean" ]; then
...
do
    ...
    sed -i -r 's/replaceleftcommentback/\/\*/g' $1
    sed -i -r 's/replacerightcommentback/\*\//g' $1
done
# end here 2013-12-29
# if [ ! -z "$(egrep '".*replace(left|right)comment.*"' $1 | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | egrep 'replace(left|right)comment')" ]; then
    # declare -i unreplacecommentcount
    # declare -i unreplacecommentline
    # unreplacecommentcount=$(egrep '".*replace(left|right)comment.*"' $1 | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | egrep 'replace(left|right)comment' | wc -l)
    # while [ $unreplacecommentcount -ne 0 ]
    # do
        # unreplacecommentline=$(egrep -n '".*replace(left|right)comment.*"' $1 | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | egrep 'replace(left|right)comment' | cut -d ':' -f 1)
        # sed -i "${unreplacecommentline}s/replaceleftcomment/\/\*/g" $1
        # sed -i "${unreplacecommentline}s/replacerightcomment/\*\//g" $1
        # unreplacecommentcount=$(egrep '".*replace(left|right)comment.*"' $1 | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | egrep 'replace(left|right)comment' | wc -l)
    # done
# fi
sed -i '/\/\*.*\*\//s/\/\*/_hejinyi\*/g' $1
...
# sed -i '/\/\/hejinyicomment.*\/\/new line by LogHelpler for comment/s/\/\/hejinyicomment//g' $1
...
function findBlock() {
    ...
    if [ "$TYPE" == "methodBlock" ]; then
        ...
        if [ -z "$(echo ${CONTENTVAR} | grep '{')" ]; then
            ...
            LINEBACKUP=$LINE
            LINE=$((${LINE} + 1))
            CONTENTVAR=$(sed -n "${LINE}p" ${FILE} | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed -e 's/_hejinyi/\n_hejinyi/g' -e 's/hejinyi_/hejinyi_\n/g' | sed 's/_hejinyi.*hejinyi_//g' | sed '/^$/d' | tr -d "\n" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | egrep -v 'super\(.*|this\(.*|^$')
            if [ ! -z "$(sed -n "${LINE}p" ${FILE} | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed -e 's/_hejinyi/\n_hejinyi/g' -e 's/hejinyi_/hejinyi_\n/g' | sed 's/_hejinyi.*hejinyi_//g' | sed '/^$/d' | tr -d "\n" | sed 's/\/\/.*//g' | egrep 'super\(.*|this\(.*')" ]; then
                DETECTSUPER="true"
            fi
            ...
            do
                ...
                if [ $DETECTSUPER == "false" ]; then
                    ...
                    CONTENTVAR=$(sed -n "${LINE}p" ${FILE} | sed 's/"[^"]*"/""/g' | sed "s/'.'//g" | sed -e 's/_hejinyi/\n_hejinyi/g' -e 's/hejinyi_/hejinyi_\n/g' | sed 's/_hejinyi.*hejinyi_//g' | sed '/^$/d' | tr -d "\n" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | egrep -v -n 'super\(.*|this\(.*')
                fi
                if [ $DEBUG == "true" ]; then
            ...
            if [ $LINE -eq $LINEBACKUP -a $DETECTRETURN == "false" ]; then
                ...
                if [ -z "$(sed -n "${LINE}p" ${FILE} | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed -e 's/_hejinyi/\n_hejinyi/g' -e 's/hejinyi_/hejinyi_\n/g' | sed 's/_hejinyi.*hejinyi_//g' | sed '/^$/d' | tr -d "\n" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | grep '}' | grep -v ';[[:space:]]*$')" -a $DETECTRETURN == "false" ]; then
                    if [ ! -z "$(sed -n "${LINE}p" ${FILE} | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed -e 's/_hejinyi/\n_hejinyi/g' -e 's/hejinyi_/hejinyi_\n/g' | sed 's/_hejinyi.*hejinyi_//g' | sed '/^$/d' | tr -d "\n" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | grep '[})].*;[[:space:]]*$')" ]; then
                        ...
                        LINE=$GLOBALLINE
                        # echo "findBrace is called for $METHODNAME"
                        if [ $DEBUG == "true" ]; then
        ...
        do
            LINE=$(($LINE - 1))
            # CONTENTVAR=$(sed -n "${LINE}p" ${FILE} | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed -e 's/_hejinyi/\n_hejinyi/g' -e 's/hejinyi_/hejinyi_\n/g' | sed 's/_hejinyi.*hejinyi_//g' | sed '/^$/d' | tr -d "\n" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | grep -v '^[[:space:]]*$' | egrep -n '[;{}][[:space:]]*$')
            CONTENTVAR=$(sed -n "${LINE}p" ${FILE} | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed -e 's/_hejinyi/\n_hejinyi/g' -e 's/hejinyi_/hejinyi_\n/g' | sed 's/_hejinyi.*hejinyi_//g' | sed '/^$/d' | tr -d "\n" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | grep -v '^[[:space:]]*$' | egrep '[;}][[:space:]]*$|{')
        done
        LINE=$(($LINE + 1))
        CONTENTVAR=$(sed -n "${LINE}p" ${FILE} | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed -e 's/_hejinyi/\n_hejinyi/g' -e 's/hejinyi_/hejinyi_\n/g' | sed 's/_hejinyi.*hejinyi_//g' | sed '/^$/d' | tr -d "\n" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | grep -v '^[[:space:]]*$')
...
function filehandle() {
    ...
    do
        ...
        ENDLINE=$line
        # echo "endline for parentheses = $ENDLINE, methodname = $METHODNAME"
        findBrace leftparentheses $file $line
        line=$(($line - 1))
        # contentvar=$(sed -n "${line}p" ${file} | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed -e 's/_hejinyi/\n_hejinyi/g' -e 's/hejinyi_/hejinyi_\n/g' | sed 's/_hejinyi.*hejinyi_//g' | sed '/^$/d' | tr -d "\n" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | grep -v '^[[:space:]]*$' | egrep '[;{}][[:space:]]*$')
        contentvar=$(sed -n "${line}p" ${file} | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed -e 's/_hejinyi/\n_hejinyi/g' -e 's/hejinyi_/hejinyi_\n/g' | sed 's/_hejinyi.*hejinyi_//g' | sed '/^$/d' | tr -d "\n" | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | grep -v '^[[:space:]]*$' | egrep '[;}][[:space:]]*$|{')
        ...
        STARTLINE=$line
        # echo "startline for parentheses = $STARTLINE"
        localstartline=$(($STARTLINE - 1))
        localendline=$(($ENDLINE + 1))
        sed -n "1,${localstartline}p" $file > $filehandletmpfile
        contentvar=$(sed -n "${STARTLINE},${ENDLINE}p" $file)
    ...
    # sed -i '/^[[:space:]]*if[[:space:]]*[^}{]*;[[:space:]]*$/s/if.*(.*)/if{/g;s/$/}/g' $file
    # sed -i '/^[[:space:]]*else[[:space:]][[:space:]]*if[[:space:]]*[^}{]*;[[:space:]]*$/s/else[[:space:]][[:space:]]*if.*(.*)/else if{/g' $file
    # sed -i '/^[[:space:]]*else[[:space:]]*[^}{]*;[[:space:]]*$/s/else/else {/g' $file
...
function addLogToMethod() {
    ...
    if [ ${ISABSTRACTMETHOD} == "true" ]; then
        ...
        do
            ...
            if [ $DEBUG == "true" ]; then
                sed -n "${wl}p" $1
                echo "startline = $STARTLINE, endline = $ENDLINE, wl = $wl"
            fi
            workoutIndent $1 $wl
            ...
            # sed -i "${wl}s/$/\/\/new line by LogHelpler/g" $1
            ENDLINE=$(($ENDLINE + 1))
            wl=$(sed -n "${STARTLINE},${ENDLINE}p" $1 | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed 's/_hejinyi.*hejinyi_//g' | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | egrep '(if|else|else[[:space:]]+if).*[[:space:]]+(return([[:space:]]+|[[:space:]]*[;\({])|throw[[:space:]]+.*)' | wc -l)
        done
        sed -i '/^MYPREFIX/s/MYPREFIX/ /g' $1
...
declare tmpCLASSNAMECOLLECTION=$(egrep '[[:space:]]+class .*{' $1 | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed 's/_hejinyi.*hejinyi_//g' | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | sed 's/.*class//g' | sed 's/{/ {/g' | awk '{print $1}' | sed 's/\n/ /g')
if [ $RECURSION -eq 0 ]; then
...
if [ ! -z "$CLASSNAMECOLLECTION" ]; then
    ...
    do
        WL=$(egrep "class $var" $1 | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed 's/_hejinyi.*hejinyi_//g' | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | egrep "class $var" | wc -l)
        if [ $WL -lt 1 ]; then
            if [ $DEBUG == "true" ]; then
                tput setf 4
            ...
            while [ $count -le $WL ]
            do
                SINGLELINE=$(egrep -n "class $var" $1 | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed 's/_hejinyi.*hejinyi_//g' | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | egrep "class $var" | sed -n "${count}p" | cut -d ':' -f 1)
...
ANONYMOUSINNERCLASS=$(egrep 'new[[:space:]]+.*\(.*\)[[:space:]]*{[[:space:]]*$' $1 | grep -v 'new[[:space:]]*.*;' | sed 's/"[^"]*"/ /g' | sed "s/'.'//g" | sed 's/_hejinyi.*hejinyi_//g' | sed 's/^[[:space:]]*\/\/.*//g' | sed 's/\/\/.*//g' | egrep 'new[[:space:]]+.*\(.*\)[[:space:]]*{[[:space:]]*$' | sed 's/){/) {/g' | awk '{print $(NF-1)}' | sed 's/([^()]*)//g')
